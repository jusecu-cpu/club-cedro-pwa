...
export const styles = {
  ...
  resumenCard: {
    ...
    sidebarFloating: {
      ...
      width: 260,
      height: '100vh',
      background: 'linear-gradient(180deg, #071a52 0%, #050b1f 100%)',
      padding: '22px 14px',
      zIndex: 30,
      overflowY: 'auto',
      display: 'flex',
    ...
    sidebarBtnActive: {
      ...
      gap: 12,
      background:
        'linear-gradient(135deg,#00cfff,#335dff)',
      color: '#fff',
      border: 'none',
      borderRadius: 16,
      padding: '14px',
      fontWeight: 800,
      boxShadow: '0 10px 25px rgba(0,207,255,.30)',
    },
    ...
    sidebarLogout: {
      ...
      fontWeight: 900,
      cursor: 'pointer',
      boxShadow: '0 10px 24px rgba(255,59,127,.24)',
    },
